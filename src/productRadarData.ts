...
export const radarLanes: RadarLane[] = [
  ...
  },
  {
    ...
    blocker: "Next: rendered asset/layer export, manual edit controls, desktop packaging, and Premiere workflow validation.",
    ...
    evidence: {
      ...
      confidence: "high",
      review: "Keep public-release language aligned with rendered-export and editing-control milestones.",
    },
  },
  {
    id: "botanica",
...
export const radarSoftwareProjects: RadarSoftwareProject[] = [
  ...
  },
  {
    ...
    summary: "Deterministic product-mockup studio: composite a seller's exact print artwork onto blank apparel plates and export clean product photos and basic promo video.",
    description: "Model Studio is a Printful/Printify-style mockup generator that an e-commerce seller can own end to end. It composites the seller's exact artwork onto blank apparel/mannequin plates for accurate output — not a generative guess — with free in-browser background removal and an optional Gemini AI assist, so the core flow runs at near-zero cost per product. The result is consistent, owned product imagery without a paid mockup subscription.",
    tags: ["Commerce", "Image compositing", "Background removal", "E-commerce"],
    repo: { label: "View source on GitHub", href: "https://github.com/armonon/photoboothstudio" },
    downloads: [],
    testingFocus: "Upload a garment photo and a print artwork file, composite them onto an apparel plate, and export the product image plus a basic promo video.",
    testSteps: ["Open Model Studio and upload a blank garment photo", "Drop in a print artwork file and position it on the plate", "Run background removal and check the composite edges", "Export a product image and a short promo video", "Confirm the output is consistent across multiple products"],
  },
  {
  ...
  },
  {
    ...
    testSteps: ["Open the live beta", "Download the 2026-05-23 export proof MP4 and manifest", "Try a simple creator-kit scenario with video/logo/voiceover assets", "Note the controls you would want before a full public release"],
    webPrototype: {
...
export const radarEvidenceLedger: RadarEvidenceItem[] = [
  ...
  },
  {
    ...
    readinessScore: 7,
    promise: "Turn a seller's exact print artwork into consistent product photos and basic promo video, owned end to end at near-zero cost per product.",
    latestProof: "Working in-browser studio that composites artwork onto apparel plates with free background removal and an optional Gemini AI assist; source is public on GitHub.",
    blocker: "Next: a hosted live deployment and a small template library of apparel plates for sellers.",
    nextStep: "Deploy a public live build and add a starter set of garment/mannequin templates.",
  ...
  },
  {
    ...
    blocker: "Next: true one-click desktop/app export plus manual asset/timeline controls; the current UI helper still uses local FFmpeg/helper steps.",
...
export const radarNextBuildSteps = [
  { title: "Interactive demos → live output", body: "Every product has an interactive demo; next is wiring real audio, MIDI, search, storyboard, and cited-answer output into each one.", state: "Now" },
  ...
  { title: "Sample Library Brain", body: "Ship a local sample database with smart-kit output and local-first privacy, then native folder scanning.", state: "Next" },
  { title: "ScenePilot one-click export", body: "Deliver one-click rendered MP4 and structured timeline export from a sample edit plan.", state: "Next" },
